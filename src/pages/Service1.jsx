...
const Service1 = () => {
  useEffect(() => {
    document.title = 'Digital Consulting - ForStackly Business Solutions';
  }, []);
...
const luxuryFeatures = [
  {
    ...
    description: "Bespoke floral artistry designed to enhance your nautical celebration."
  },
  {
    icon: FaUsers,
    title: "VIP Guest Services",
    description: "Personalized concierge for a seamless luxury experience onboard."
  },
  {
    icon: FaUtensils,
    title: "Gourmet Catering",
    description: "Tailored menus crafted by world-class chefs, served with elegance."
  },
  {
    icon: FaMusic,
    title: "Onboard Entertainment",
    description: "Live music, DJs, and curated performances for unforgettable moments."
  },
  {
    icon: FaCameraRetro,
    title: "Photography & Videography",
    description: "Capture every cherished moment with cinematic photography and film."
  },
  {
    icon: FaPalette,
    title: "Personalized Décor & Styling",
    description: "Exclusive themes and luxury styling to reflect your unique love story."
  }
];
  ...
  const faqs = [
  {
    question: 'How far in advance should we book our luxury yacht wedding?',
    answer: 'We recommend booking at least 6 to 12 months in advance to secure your preferred yacht and date, allowing ample time for personalized planning and coordination.'
  },
  {
    question: 'What kind of customization options are available for the wedding?',
    answer: 'Our services include fully personalized décor, tailored menus, entertainment options, and bespoke floral arrangements to perfectly match your vision and style.'
  },
  {
    question: 'Can you accommodate special dietary needs and preferences?',
    answer: 'Absolutely. Our gourmet catering team works closely with you to create exquisite menus that cater to all dietary requirements and preferences, ensuring every guest is delighted.'
  },
  {
    question: 'What is included in the VIP guest services onboard?',
    answer: 'VIP services include personalized concierge support, luxury amenities, seamless guest management, and exclusive entertainment to provide an unforgettable experience.'
  }
];
  ...
  <div className="hero-overlay">
    <div className="hero-content">
      <h1 className="hero-title animate-slide-in">Luxury Yacht Wedding</h1>
      <p className="hero-paragraph animate-fade-up">
        Set sail for a breathtaking celebration on the water—experience elegance, romance, and unforgettable moments with a bespoke wedding aboard a luxury yacht.
...
<section className="section features-section">
  <div className="container">
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <h2>Extraordinary Wedding Enhancements</h2>
      <p>
        A curated celebration on the water, blending elegant décor, tailored cuisine, 
        and expert planning.
      </p>
    </motion.div>
        ...
        <div className="container">
          <div className="grid-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2>Luxury Yacht Wedding</h2>
              <p>
               Our luxury yacht wedding services create a truly unique and unforgettable celebration, blending timeless elegance, romantic ambiance, and stunning ocean vistas. From personalized planning to exquisite details, we ensure your special day is a flawless and breathtaking experience surrounded by the beauty of the sea.</p>
      ...
      <section className="section faq-section">
        <div className="container">
          ...
          >
            ...
            <p>Get answers to common questions about our digital consulting services</p>
          </motion.div>
