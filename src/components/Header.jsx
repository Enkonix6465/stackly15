            ...
            >
              ...
              {isServicesDropdownOpen && (
                <div className={`absolute top-full left-0 mt-2 w-48 rounded-md shadow-lg border py-2 bg-[var(--sidebar-bg)] border-[var(--border-color)]`}>
                  ...
                  <Link to="/service1" className={`block px-4 py-2 text-[var(--text-color)] hover:bg-[var(--hover-bg)]`} onClick={() => setIsServicesDropdownOpen(false)}>Luxury Yacht Wedding</Link>
                  <Link to="/service2" className={`block px-4 py-2 text-[var(--text-color)] hover:bg-[var(--hover-bg)]`} onClick={() => setIsServicesDropdownOpen(false)}>Modern Corporate Gala</Link>
                  <Link to="/service3" className={`block px-4 py-2 text-[var(--text-color)] hover:bg-[var(--hover-bg)]`} onClick={() => setIsServicesDropdownOpen(false)}>Birthday Celebration</Link>
                  <Link to="/service4" className={`block px-4 py-2 text-[var(--text-color)] hover:bg-[var(--hover-bg)]`} onClick={() => setIsServicesDropdownOpen(false)}>Mountain Retreat</Link>
                  <Link to="/service5" className={`block px-4 py-2 text-[var(--text-color)] hover:bg-[var(--hover-bg)]`} onClick={() => setIsServicesDropdownOpen(false)}>Festive Holiday Soiree</Link>
                  <Link to="/service6" className={`block px-4 py-2 text-[var(--text-color)] hover:bg-[var(--hover-bg)]`} onClick={() => setIsServicesDropdownOpen(false)}>Annual Conference</Link>
                </div>
              )}
            </div>
