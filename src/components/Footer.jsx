...
  </a>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><Link to="/service1" className="text-[var(--text-muted)] hover:text-[var(--hover-color)] transition-colors duration-200">Luxury Yacht Wedding</Link></li>
              <li><Link to="/service2" className="text-[var(--text-muted)] hover:text-[var(--hover-color)] transition-colors duration-200">Modern Corporate Gala</Link></li>
              <li><Link to="/service3" className="text-[var(--text-muted)] hover:text-[var(--hover-color)] transition-colors duration-200">Birthday Celebration</Link></li>
              <li><Link to="/service4" className="text-[var(--text-muted)] hover:text-[var(--hover-color)] transition-colors duration-200">Mountain Retreat</Link></li>
              <li><Link to="/service5" className="text-[var(--text-muted)] hover:text-[var(--hover-color)] transition-colors duration-200">Festive Holiday Soiree</Link></li>
              <li><Link to="/service6" className="text-[var(--text-muted)] hover:text-[var(--hover-color)] transition-colors duration-200">Annual Conference</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[var(--text-muted)]">+1(555)123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[var(--text-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M..."/></svg>
