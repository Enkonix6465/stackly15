...
const translations = {
  en: {
    ...
    servicesLinks: [
      { to: "/service1", label: "Luxury Yacht Wedding" },
      { to: "/service2", label: "Modern Corporate Gala" },
      { to: "/service3", label: "Birthday Celebration" },
      { to: "/service4", label: "Mountain Retreat" },
      { to: "/service5", label: "Festive Holiday Soiree" },
      { to: "/service6", label: "Annual Conference" },
    ],
  ...
  ar: {
    ...
    servicesLinks: [
      { to: "/service1", label: "زفاف يخت فاخر" },
      { to: "/service2", label: "حفل عصري للشركات" },
      { to: "/service3", label: "احتفال عيد ميلاد" },
      { to: "/service4", label: "ملاذ الجبال" },
      { to: "/service5", label: "سهرة العطلات الاحتفالية" },
      { to: "/service6", label: "المؤتمر السنوي" },
    ],
  ...
  he: {
    ...
    servicesLinks: [
      { to: "/service1", label: "חתונה על יאכטה יוקרתית" },
      { to: "/service2", label: "גלת חברות מודרנית" },
      { to: "/service3", label: "חגיגת יום הולדת" },
      { to: "/service4", label: "מרחב הרים" },
      { to: "/service5", label: "מפלגת חגים חגיגית" },
      { to: "/service6", label: "כנס שנתי" },
    ],
